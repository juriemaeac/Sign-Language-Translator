...
class BottomNavAvatar extends StatefulWidget {
  @override
  _BottomNavAvatarState createState() => _BottomNavAvatarState();
}

class _BottomNavAvatarState extends State<BottomNavAvatar> {
  //int _page = 0;
